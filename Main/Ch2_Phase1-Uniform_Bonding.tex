...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        % \psframebox[fillcolor={rgb,0.16:red,0.84:green,1.00:blue,1}]{\textcolor{white}{TEST}}
        % \fillRGB{255}{255}{0}\node[fill,draw]{{\tt fillRGB: 255,255,0} };
        % \fillRGB{255}{255}{0}\draw[fill,draw] (0, 0) rectangle (1, 1);
...
% Next figures also have tobe regenerated
